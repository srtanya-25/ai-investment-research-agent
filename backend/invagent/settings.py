"""
Django settings for the AI Investment Research Agent.
Pattern: decouple for .env, dj_database_url for the DB,
...
ROOT_URLCONF       = "invagent.urls"
WSGI_APPLICATION   = "invagent.wsgi.application"
...
# CORS
# Required because the frontend (port 5173) and backend (port 8000) are different origins
...
# Gemini / LangChain
# The AI layer reads these. When the key is missing the app falls back to a
